...
{"email": "ivan@example.com", "password": "Password123", "firstName": "Иван", "lastName": "Петров", "phone": "+79001234567"}

**Успешный ответ (201)**

{"timestamp": "2026-05-27T10:30:00Z", "status": 201, "message": "User registered successfully", "userId": 12345}

**Ошибка валидации (400)**

{"timestamp": "2026-05-27T10:30:00Z", "status": 400, "error": "Bad Request", "message": "Password must be at least 8 characters", "path": "/api/v1/register"}

**Ошибка дубликата (409)**

{"timestamp": "2026-05-27T10:30:00Z", "status": 409, "error": "Conflict", "message": "User with email ivan@example.com already exists", "path": "/api/v1/register"}
